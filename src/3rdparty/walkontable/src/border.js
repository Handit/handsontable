...
class Border {
    ...
    createBorders(settings) {
        ...
        for (let i = 0; i < 5; i++) {
            ...
            style = div.style;
            let backgroundColor = (this.settings[position] && this.settings[position].color) ? this.settings[position].color : settings.border.color;
            style.setProperty("background", backgroundColor, "important")
